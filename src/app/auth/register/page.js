      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative z-10 w-full">
        <div className="text-center bg-[#0b1120]/80 backdrop-blur-2xl rounded-4xl shadow-2xl border border-white/5 p-12 relative overflow-hidden max-w-sm w-full">
          ...
          <div className="relative z-10">
            <div className="w-20 h-20 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(79,70,229,0.2)]">
            ...
            <p className="text-indigo-400/80 font-medium text-sm leading-relaxed mb-6">
              We&apos;ve sent a verification link to<br/>
              <span className="text-white font-semibold">{form.email}</span>
            </p>
            <p className="text-slate-400 text-xs mb-8">
              Click the link in the email to activate your account. Links expire in 24 hours.
            </p>
            <Link href="/auth/login" className="inline-block w-full py-3 px-4 rounded-xl text-white font-medium bg-white/10 hover:bg-white/20 border border-white/10 transition-all text-sm">
              Return to Login
            </Link>
          </div>
        </div>
